    ...
    <article className="grid grid-cols-2 gap-14">
      <section>
        <div className="aspect-[1.75] relative [&>p]:text-yellow-950">
          ...
          <span className="z-50 text-yellow-50 absolute bottom-6 left-8 font-semibold text-[32px]">
            {cooperative.name}
          </span>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            cultivo da soja, nossa cooperativa se dedica a fornecer produtos de alta qualidade para o mercado,
            assegurando preços justos para os produtores e promovendo o desenvolvimento social e econômico das
            comunidades onde atuamos.
          </p>

          <p>
            Com um compromisso inabalável com a sustentabilidade, empregamos práticas agrícolas inovadoras que preservam
            o meio ambiente e garantem a qualidade da nossa soja. Através da constante busca por conhecimento e
            tecnologia, investimos na capacitação dos nossos cooperados e na modernização da produção, impulsionando a
            competitividade do nosso setor.
          </p>
